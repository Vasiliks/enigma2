...
from enigma enigma import eTimer, eDVBDB
...
from Screens.About import CommitInformation
...
class UpdatePlugin(Screen, ProtectedScreen):
	...
	def startActualUpgrade(self, answer):
		...
		if answer[1] == "cold":
			...
			self.session.openWithCallback(boundFunction(self.opkgCallback, OpkgComponent.EVENT_DONE, None), CommitInformation)
