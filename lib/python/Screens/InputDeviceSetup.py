		...
		<widget source="list" render="Listbox" position="5,50" size="550,280" zPosition="10" scrollbarMode="showOnDemand">
			...
			<!--  device, description, devicepng, divpng  -->
							{"template": [
									...
									MultiContentEntryText(pos = (65, 6), size = (450, 54), font=0, flags = RT_horizontalAlignment_LEFT|RT_verticalAlignment_CENTER|RT_WRAP, text = 1), # index 1 is the interfacename
								],
