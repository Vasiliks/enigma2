...
class AnimationSetupConfig(ConfigListScreen, Screen):
	...
	def makeConfigList(self):
		...
		self.entrylist.append((_("Animation Speed"), config.misc.window_animation_speed))
		self.entrylist.append((_("Enable Focus Animation"), config.misc.listbox_animation_default))
