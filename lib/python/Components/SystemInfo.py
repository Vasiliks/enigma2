...
BoxInfo.setItem("DifferentLCDSettings", MODEL in ("spycat4kmini", "osmega"))
BoxInfo.setItem("Display", BoxInfo.getItem("FrontpanelDisplay") or BoxInfo.getItem("StandbyLED") or MODEL in ("dreamone", "dreamtwo"))
BoxInfo.setItem("DisplayLED", BoxInfo.getItem("FrontpanelDisplay") and MODEL not in ("vusolo4k", "vuduo4k", "vuduo4kse", "vuultimo4k", "vuuno4k", "vuuno4kse", "atemionemesis"))
...
BoxInfo.setItem("FrontpanelDisplay", fileCheck("/dev/dbox/oled0") or fileCheck("/dev/dbox/lcd0"))
BoxInfo.setItem("FrontpanelDisplayGrayscale", fileExists("/dev/dbox/oled0"))
BoxInfo.setItem("FrontpanelLEDBlinkControl", fileCheck("/proc/stb/fp/led_blink"))
BoxInfo.setItem("FrontpanelLEDBrightnessControl", fileCheck("/proc/stb/fp/led_brightness"))
BoxInfo.setItem("FrontpanelLEDColorControl", fileCheck("/proc/stb/fp/led_color"))
BoxInfo.setItem("FrontpanelLEDFadeControl", fileCheck("/proc/stb/fp/led_fade"))
...
BoxInfo.setItem("LCDsymbol_circle_recording", fileCheck("/proc/stb/lcd/symbol_circle") or PLATFORM == "gfuturesbcmarm" and fileCheck("/proc/stb/lcd/symbol_recording") or exists("/proc/led") and BRAND == "azbox")
...
BoxInfo.setItem("VFDRepeats", BRAND != "ixuss" and not BoxInfo.getItem("7segment"))
